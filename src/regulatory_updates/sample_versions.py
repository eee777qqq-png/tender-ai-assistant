...
демонстрации и тестирования Агента 10, пока нет подтверждённого доступа к
реальному источнику нормативной базы расценок (ждём ответ Сметрикс/ФГИС ЦС,
см. CLAUDE.md, «Известные пробелы») и нет отдельного мониторинга изменений
законодательства.
...
Минстроя с индексами по видам работ.
