...
Это полный официальный раздел «Строительство», а не подобранный вручную
перечень видов работ под нишу пилота (капремонт) — при необходимости сузить
список (например, исключить коды чисто проектной документации 41.10.x)
нужно решение владельца продукта, см. CLAUDE.md.
"""
