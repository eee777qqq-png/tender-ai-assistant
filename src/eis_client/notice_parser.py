...
# (подтверждено на обоих документах — например, "г. Москва, …" и "обл.
# Ростовская, м.р-н Аксайский, …", в формате ГАР — тип места ПЕРЕД
# названием) — но это неструктурированный адрес, разбор текстом не
# реализован, менее надёжен для честного `None`, чем префикс ИНН.
